...
This repository contains our reproduction of the MaskFeat self-supervised learning approach, specifically focusing on fine-tuning Vision Transformers (ViT) on ImageNet for image classification. We successfully reproduced the paper's key results and conducted additional experiments analyzing the impact of batch size and warmup schedules.

### Key Achievements

- ✅ **ImageNet-100**: Achieved **89.42% top-1 accuracy** (98.20% top-5)
- ✅ **ImageNet-1K**: Achieved **79.08% top-1 accuracy** with batch size 128
- ✅ **ImageNet-1K**: Achieved **~82% top-1 accuracy** (projected) with batch size 512
...
| ImageNet-1K | 1000 | 512 | 5 epochs | **~82%** (proj.) | - | ~16h |
