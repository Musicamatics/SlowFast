...
print("Loading ImageNet-100 from parquet...")
dataset = load_dataset("parquet", data_dir="./data/imagenet-100/data")

output_dir = Path("./data/imagenet-100-converted")
...
print(f"\nDataset structure:")
print(f"  {output_dir}/")
print(f"    train/ - {len(dataset['train']):,} images in 100 classes")
print(f"    val/   - {len(dataset['validation']):,} images in 100 classes")
